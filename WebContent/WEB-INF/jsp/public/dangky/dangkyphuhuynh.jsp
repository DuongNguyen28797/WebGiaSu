  	...
  	<div class="container">
        ...
        <div class="breadcrumb1">
            <ul>
                ...
                <li class="current-page">Đăng ký Phụ Huynh</li>
            </ul>
        </div>
  	</div>
  </div>
				...
				<c:if test="${dkph != null}">
				   <h3 style="color: #1E90FF; margin-left: 38%"><b> Đăng kí thành công !</b></h3>
					...
					<div class="panel-heading">
						<h3 class="panel-title" style="font-family: arial;">Đăng ký phụ huynh</h3>
					</div>
					<div class="panel-body">
						<form id="signupForm1" method="post" class="form-horizontal" action="${pageContext.request.contextPath}/dang-ky-phu-huynh">
